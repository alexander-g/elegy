...
def load_pretrained_weights(
    module: Module, weights: str, pretrained_urls: tp.Dict[str, str]
):
    ...
    jax.eval_shape(module.init(rng=types.RNGSeq(42)), x)
    module.set_default_parameters(parameters, collections)
